...
class MessageData:
    ...
    text: str
    timestamp: str
    id: str = ""  # Unique message ID (timestamp in ms)
    prompt_used: str = ""
    supervisor_response_time_ms: Optional[int] = None
    therapist_response_time_ms: Optional[int] = None
    audio_file_path: Optional[str] = None  # Path to MP3 file for therapist messages
...
class SessionData:
    ...
    audio_files: Dict[str, str] = None  # message_id -> audio filename mapping
